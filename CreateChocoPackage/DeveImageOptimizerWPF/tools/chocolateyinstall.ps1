...
$checksum = checksum -t sha256 -f $fileLocation
...
$packageArgs = @{
  ...
  softwareName  = 'DeveImageOptimizerWPF*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
